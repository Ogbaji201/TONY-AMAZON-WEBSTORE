...
//   Heart 
// } from "lucide-react";
// // import EmblaCarousel, { dummySlides } from "@/components/EmblaCarousel";
...
// // Fetch all products with proper category population
// async function getProducts() {
//   try {
//     const res = await fetch("http://localhost:1337/api/products?populate[category][populate][0]=Name&populate=*", {
//       cache: "no-store",
//     });
...
//   }
// }
// // Fetch featured products with proper category population
// async function getFeaturedProducts() {
//   try {
//     const res = await fetch(
//       "http://localhost:1337/api/products?filters[featured][$eq]=true&populate[category][populate][0]=Name&populate=*",
//       {
//         cache: "no-store",
//       }
//     );
...
//   return product.category?.data?.attributes?.Name || 'Uncategorized';
// }

// // Extract unique categories for navigation
// function getUniqueCategories(products: Product[]): string[] {
//   const categories = products
//     .map(product => product.category?.data?.attributes?.Name)
//     .filter((name): name is string => !!name); // Type guard to filter out undefined/null
...
//         {/* This will use the default dummySlides */}
//       </section>
...
//               <p className="text-gray-600">Free shipping on all orders over ₦25,000</p>
//             </div>
...
//               const categoryName = getCategoryName(product); // Use the helper function
